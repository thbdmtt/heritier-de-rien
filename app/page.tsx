...
const description =
  "Découvrez Héritier de rien, Les petits cailloux du tacot, de Gilbert Myotte. L’édition brochée est mise en avant sur Amazon.fr. L’édition papier paraîtra prochainement.";
      ...
      <main id="contenu" className="detail-main">
        <article className="detail-layout purchase-page">
          <div className="detail-copy">
            ...
            <p className="eyebrow">Édition brochée</p>
            ...
            <p className="detail-lead">
              L’édition papier paraîtra prochainement.
            </p>
            ...
            <section className="purchase-card" aria-labelledby="kindle-title">
              ...
              <p>
                ...
                Référence Amazon&nbsp;: {AMAZON_KINDLE_ASIN}.
              </p>
          ...
          <figure className="detail-visual">
            ...
            <figcaption>Édition brochée · Gilbert Myotte</figcaption>
          </figure>
        </article>
      </main>
